...
Готовые файлы ввода лежат рядом с заданием: `./a.out < ten.txt`.
...
```
e  ≈ 2.718281828459046  (истинное 2.718281828459045, ошибка 4.44e-16)
pi ≈ 3.086079801123835  (истинное 3.141592653589793, ошибка 5.55e-02)
```

`e` уже сошёлся до предела точности `double`, а `π` (Лейбниц) за те же 18 слагаемых всё ещё точен лишь до первого знака.

---

**[million.txt](million.txt)**
...
```
e  ≈ 2.718281828459046  (истинное 2.718281828459045, ошибка 4.44e-16)
pi ≈ 3.141591653589774  (истинное 3.141592653589793, ошибка 1.00e-06)
```

Даже миллион слагаемых даёт `π` только 6 верных знаков — вот она, «мучительная» сходимость Лейбница.
...
```
e  ≈ 1.000000000000000  (истинное 2.718281828459045, ошибка 1.72e+00)
pi ≈ 4.000000000000000  (истинное 3.141592653589793, ошибка 8.58e-01)
```
